...
public class UserController {
    ...
    public ResponseEntity<HashMap<String, String>> sendVerificationOtpToUser(
            ...
            @RequestParam (name = "phoneNumber",required = false) String phoneNumber) throws  IOException {
        log.info("Sending verification OTP to email: {}", email);
        HashMap<String, String> response = userService.sendVerificationOtpToUser(email,phoneNumber);
        return ResponseEntity.ok(response);
    }
